...
- Default admin password: `REMOVED-CREDENTIAL-ROTATED-20260828` (configurable via `DEFAULT_ADMIN_PASSWORD` env var)
...
| `DEFAULT_ADMIN_PASSWORD` | `REMOVED-CREDENTIAL-ROTATED-20260828` | Password for auto-created admin account on first run |
