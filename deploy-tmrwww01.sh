#!/bin/bash
# Deployment script for LLM Proxy Manager on TMRwww01
# This is the primary node in the cluster

set -e  # Exit on error

echo "========================================="
echo "LLM Proxy Manager - TMRwww01 Deployment"
echo "========================================="

# Configuration
NODE_ID="tmrwww01"
NODE_NAME="TMRwww01 LLM Proxy (Primary)"
NODE_URL="http://tmrwww01:3000"
...
# Create .env file
cat > .env <<EOF
# LLM Proxy Manager - TMRwww01 Configuration
NODE_ENV=production
PORT=3000
...
# Cluster Configuration (Primary Node)
...
# SMTP_FROM=llm-proxy@tmrwww01
# SMTP_TO=admin@example.com
# SMTP_MIN_SEVERITY=WARNING

# Provider API Keys (Add your keys here or configure via Web UI)
# ANTHROPIC_KEY_1=sk-ant-api03-...
# GOOGLE_API_KEY_1=AIzaSy...
# OPENAI_KEY_1=sk-...
EOF

echo -e "${YELLOW}IMPORTANT: Generated cluster secret:${NC}"
echo "$CLUSTER_SECRET"
echo "Save this secret - you'll need it for the other nodes!"
echo ""
...
echo "2. Add your provider API keys in the Web UI"
echo "3. Deploy to TMRwww02 and c1conversations-avaya-01 using the cluster secret above"
echo "4. Configure SMTP notifications (edit $INSTALL_DIR/.env)"
echo ""
