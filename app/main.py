...
async def lifespan(app: FastAPI):
    ...
    set_service_info(version="2.6.2", node_id=settings.cluster_node_id or "")
    init_tracer(service_name="llm-proxy", version="2.6.2")
...
@app.get("/health")
async def health():
    return {"status": "ok", "version": "2.6.2"}


@app.get("/version")
async def version():
    return {"service": "llm-proxy", "version": "2.6.2", "docs": "/docs"}
