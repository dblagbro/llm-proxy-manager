...
from app.api.oauth_capture.terminal import router as _terminal_router
...
# passthrough LAST so /_presets, /_profiles, /_log, /_terminal routes take
# precedence over the catch-all (/{profile_name}/{path:path})
