...
- **Repro:** `tests/conftest.py:15` previously read `ADMIN_PASS = "Super*120120"` — a hardcoded production-admin password committed in git history on a public repository. Visible to anyone who clones or browses the repo.
...
- **Tests:** the test file's source-guard asserts `Super*120120` is no longer present and that the env var name is wired in.
