#!/bin/bash
# Deployment script for LLM Proxy Manager on TMRwww02
# This is a secondary node in the cluster

set -e  # Exit on error

echo "========================================="
echo "LLM Proxy Manager - TMRwww02 Deployment"
echo "========================================="

# Configuration
NODE_ID="tmrwww02"
NODE_NAME="TMRwww02 LLM Proxy (Secondary)"
NODE_URL="http://tmrwww02:3000"
...
# Create .env file
cat > .env <<EOF
# LLM Proxy Manager - TMRwww02 Configuration
NODE_ENV=production
PORT=3000
...
# Cluster Configuration (Secondary Node)
...
echo "- This node will sync users and API keys from TMRwww01"
echo "- Configure providers independently via the Web UI"
echo "- You can set different provider priorities than TMRwww01"
echo ""
