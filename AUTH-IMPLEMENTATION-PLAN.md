...
- Default admin user: dblagbro / REMOVED-CREDENTIAL-ROTATED-20260828
```
...
test('login flow', async ({ page }) => {
  ...
  await page.fill('[name=password]', 'REMOVED-CREDENTIAL-ROTATED-20260828');
...
- [ ] Can login with dblagbro / REMOVED-CREDENTIAL-ROTATED-20260828
